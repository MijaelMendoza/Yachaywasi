...
class ClienteController
{
    ...
    {
        $this->clienteModel->agregarCliente($datosCliente['nombre'], $datosCliente['ci'], $datosCliente['direccion'], $datosCliente['telefono'], $datosCliente['correo'], $datosCliente['fecha_registro'], $datosCliente['segmento_cliente'], $datosCliente['genero']);
    }

    public function actualizarCliente($cu, $datosCliente)
    {
        $this->clienteModel->actualizarCliente($cu, $datosCliente['nombre'], $datosCliente['ci'], $datosCliente['direccion'], $datosCliente['telefono'], $datosCliente['correo'], $datosCliente['fecha_registro'], $datosCliente['segmento_cliente'], $datosCliente['genero']);
